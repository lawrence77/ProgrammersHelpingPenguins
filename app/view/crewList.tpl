...
<div class="container">
		...
		foreach($crews as $c)
		{
            ...
            */
            ...
            echo "<div class ='col-lg-4'> <table><tr><td> <div class='bomber-table-title'><a href=\"".$BASE_URL."/crews/".$c->id."\">Campaign: ".$c->name." </a> Bomber Group<div class='bomber-table-content'>". $c-> bomberGroup . "</div></div>";
